...
//  Viral
//
//  Created by Aamir Shaikh on 12/07/2017.
...
//                var str = ""
//                string.characters.forEach({ str.append($0 * Character(2)) })
//                string = str
//            }
//            
...
//        }
    ...
    public extension UIColor {
        ...
        public struct trendingTubes {
            public static var appPurple = UIColor.init(hex: 0x952EB1)
            public static let highlightColor = UIColor.init(red: 239/255, green: 59/255, blue: 101/255, alpha: 0.1)
            public static var redColor = UIColor(red: 229/255, green: 28/255, blue: 0/255, alpha: 1)
            public static var appSkyBlue = UIColor.init(hex: 0x3CC1D3)
            public static var pink = UIColor.init(hex: 0xF92987)
            public static var cancelRed = UIColor.init(hex: 0xD13E3E)
            public static var greyBackground = UIColor.init(hex: 0xEBEAEF)
        }
